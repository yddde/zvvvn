...
local function sendd(chat_id, reply_to_message_id, text)
local TextParseMode = {ID = "TextParseModeMarkdown"}
tdcli_function ({ID = "SendMessage",chat_id_ = chat_id,reply_to_message_id_ = reply_to_message_id,disable_notification_ = 1,from_background_ = 1,reply_markup_ = nil,input_message_content_ = {ID = "InputMessageText",text_ = text,disable_web_page_preview_ = 1,clear_draft_ = 0,entities_ = {},parse_mode_ = TextParseMode,},}, dl_cb, nil)
end
...
{
{text = ''..(channel_ts or "TshAkE TEAM")..'', url=''..(channel_user_ts or 't.me/zVVVn_files')..''},
},
}
local keko = "https://api.telegram.org/bot" ..token.. '/sendMessage?chat_id=' .. chat_id
if reply_to_message_id ~= 0 then
keko = keko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق مدى لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
info = '👤┇بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'zVVVn')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(msg.sender_user_id_, keko333)
end
if value == "prore" then
function get_zVVVn(zVVVn1,zVVVn2,zVVVn3)
local id_zVVVn = zVVVn2.sender_user_id_
function keko333(extra,result,success)
if result.first_name_ then
if #result.first_name_ < 15 then 
else
...
info = '👤┇العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'zVVVn')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(id_zVVVn, keko333)
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,get_zVVVn)
end
...
info = '👤┇العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'zVVVn')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
else
sendd(msg.chat_id_, msg.id_,'👥| لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 📌| اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس مدى \n 🦁┇[ملفات يدعمها سورس مدى](t.me/zVVVn_files)', 1, 'md')
end
else
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس مدى \n 🦁┇[ملفات يدعمها سورس مدى](t.me/zVVVn_files)', 1, 'md')
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'zVVVn_files')..')\n\n☑┇تم رفعه مطور'
else
texts = '✖┇خطاء'
end
...
local hash =  'tshake:'..bot_id..'gbanned:'
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'zVVVn_files')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'tshake:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'zVVVn_files')..')\n��┇تم الغاء حظره من المجموعات البوت'
...
os.execute('cd libs && wget https://raw.githubusercontent.com/yddde/zVVVn/master/libs/utils.lua')
os.execute('rm -rf Tshake.lua')
os.execute('wget https://raw.githubusercontent.com/yddde/zVVVn/master/Tshake.lua')
os.exit()
return false
end
if text == "تفعيل"  then
...
function TSby(extra,result,success)
info = '👁‍🗨※بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'zVVVn_files')..')\n'
if not database:get( 'tshake:'..bot_id.."charge:"..msg.chat_id_) then
function thsake_info(k1,k2)
send(msg.chat_id_, msg.id_, 1, "❕┇المجموعه {"..(k2.title_ or "").."} معطله سابقا", 1, 'md')
end
...
if text then
--         »»               Start tshake lock                       ««              --
if (text == "قفل المنشن") then
local tsX_o = database:get("lock_tag:tshake"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل المنشن ")
else
tsX000("lock",msg,"??┇ تم قفل المنشن ")
...
if (text == "فتح المنشن") then
local tsX_o = database:get("lock_tag:tshake"..msg.chat_id_..bot_id)
if not tsX_o then
tsX000("lock",msg,"⚠️┇بالفعل تم فتح المنشن ")
else
tsX000("lock",msg,"⚠️┇تم فتح المنشن ")
database:del("lock_tag:tshake"..msg.chat_id_..bot_id,"ok")
end
end
...
if (text and text == 'تفعيل المغادره') and devbott(msg)  then
send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل مغادره البوت', 1, 'md')
database:del('tshake:'..bot_id..'leave:groups')
end

if (text and text == 'تعطيل المغادره') and devbott(msg)  then
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'zVVVn')..')\n┇ 🔖┇تم رفعة منشئ اساسي  في البوت  '
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
if text == 'توجيه للكل' and tonumber(msg.reply_to_message_id_) > 0  and devbott(msg)  then  
local group = database:smembers('tshake:'..bot_id..'groups') 
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]
},function(arg,data) end,nil)
end
...
-------------
if text == 'توجيه خاص' and tonumber(msg.reply_to_message_id_) > 0  and devbott(msg)  then  
...
if text == "تنظيف المشتركين" and devbott(msg)  then
local pv = database:smembers('tshake:'..bot_id.."userss")
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]
...
----------------
if text == "تنظيف القروبات" and devbott(msg)  then
local group = database:smembers('tshake:'..bot_id..'groups') 
local w = 0
local q = 0
for i = 1, #group do
...
if (text:match("^عدد القروبات$") or text:match("^الاحصائيات$")) and is_vip(msg) then
...
send(msg.chat_id_, msg.id_, 1, '• المجموعات :\n📊┇عدد القروبات الكلي ~⪼  *{'..gps..'}*\n🔋┇عدد القروبات المفعله ~⪼  *{'..gps2..'}*\n🔌┇عدد القروبات الغير مفعله ~⪼  *{'..(gps - gps2)..'}*\n💡┇عدد القروبات المدفوعه ~⪼  *{'..(gps3)..'}*\n⏱┇عدد القروبات المتفاعله اليوم ~⪼  *{'..(gps9)..'}*\n\n• الاعضاء :\n👥┇ عدد اعضاء الخاص : {`'..user..'`}', 1, 'md')
end
...
io.popen(curl) 
		...
		----------------
if text and (text == "القروبات المتفاعله" or text == "روابط القروبات المتفاعله") then
local gpss = database:smembers("thsake:good"..bot_id..os.date("%d")) or 0
text233 = '📊┇روابط القروبات المتفاعله\n\n'
for i=1, #gpss do
...
if text:match("^تحديث السورس$")  and devbott(msg)  then
send(msg.chat_id_, msg.id_, 1, '☑️┇تم التحديث', 1, 'md')
os.execute('rm -rf ./libs/utils.lua')
os.execute('cd libs && wget https://raw.githubusercontent.com/yddde/zVVVn/master/libs/utils.lua')
os.execute('rm -rf Tshake.lua')
...
if (text and text == 'مسح امر المطور بالكليشه') and devbott(msg)  then
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'zVVVn')..')\n🔖┇تم رفعة منشئ  في البوت'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
----------------------------------------
if text:match("^رفع ادمن بالقروب (%d+)$") and  is_creatorbasic(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local apmd = {string.match(text, "^(رفع ادمن بالقروب) (%d+)$")}
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tsX000(apmd[2],msg,'🔖┇تم رفعة ادمن   في القروب')
end
if text:match("^رفع ادمن بالقروب$")  and is_creatorbasic(msg) and msg.reply_to_message_id_ then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tsX000("prore",msg,'🔖┇تم رفعة ادمن   في القروب')
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
if text:match("^رفع ادمن بالقروب @(.*)$") and is_creatorbasic(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local apmd = {string.match(text, "^(رفع ادمن بالقروب) @(.*)$")}
function promote_by_username(extra, result, success)
if result.id_ then
...
--------------------------------------
-------------------------------------
if text:match("^رفع منشئ بالقروب (%d+)$") and  is_creatorbasic(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local apmd = {string.match(text, "^(رفع منشئ بالقروب) (%d+)$")}
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tsX000(apmd[2],msg,'🔖┇تم رفعة منشئ   في القروب')
end
if text:match("^رفع منشئ بالقروب$")  and is_creatorbasic(msg) and msg.reply_to_message_id_ then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tsX000("prore",msg,'🔖┇تم رفعة منشئ في القروب')
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
if text:match("^رفع منشئ بالقروب @(.*)$") and is_creatorbasic(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local apmd = {string.match(text, "^(رفع منشئ بالقروب) @(.*)$")}
function promote_by_username(extra, result, success)
if result.id_ then
HTTPS.request("https://api.telegram.org/bot" .. token .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'zVVVn')..')\n🔖┇تم رفعة منشئ   في القروب'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
----------------------------------
if text:match("^تنزيل ادمن بالقروب (%d+)$") and  is_creatorbasic(msg) then
local apmd = {string.match(text, "^(تنزيل ادمن بالقروب) (%d+)$")}
...
tsX000(apmd[2],msg,'🔰┇تم تنزيله ادمن   في القروب')
end
if text:match("^تنزيل ادمن بالقروب$")  and is_creatorbasic(msg) and msg.reply_to_message_id_ then
function promote_by_reply(extra, result, success)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
tsX000("prore",msg,'🔰┇تم تنزيله ادمن   في القروب')
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
if text:match("^تنزيل ادمن بالقروب @(.*)$") and is_creatorbasic(msg) then
local apmd = {string.match(text, "^(تنزيل ادمن بالقروب) @(.*)$")}
function promote_by_username(extra, result, success)
if result.id_ then
HTTPS.request("https://api.telegram.org/bot" .. token .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'zVVVn')..')\n🔰┇تم تنزيله ادمن   في القروب'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
---------------------------------------
-------------------------------------
if text:match("^تنزيل منشئ بالقروب (%d+)$") and  is_creatorbasic(msg) then
local apmd = {string.match(text, "^(تنزيل منشئ بالقروب) (%d+)$")}
HTTPS.request("https://api.telegram.org/bot" .. token .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..apmd[2].."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
tsX000(apmd[2],msg,'🔰┇تم تنزيله منشئ   في القروب')
end
if text:match("^تنزيل منشئ بالقروب$")  and is_creatorbasic(msg) and msg.reply_to_message_id_ then
function promote_by_reply(extra, result, success)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
tsX000("prore",msg,'🔰┇تم تنزيله منشئ   في القروب')
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
if text:match("^تنزيل منشئ بالقروب @(.*)$") and is_creatorbasic(msg) then
local apmd = {string.match(text, "^(تنزيل منشئ بالقروب) @(.*)$")}
function promote_by_username(extra, result, success)
if result.id_ then
HTTPS.request("https://api.telegram.org/bot" .. token .. "/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'zVVVn')..')\n🔰┇تم تنزيله منشئ   في القروب'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
if ck_mod(result.sender_user_id_, msg.chat_id_) or is_creatorbasicid(result.sender_user_id_, msg.chat_id_)then
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apba[2] or 'zVVVn')..')\n☑┇تم حظره من المجموعه'
...
if ck_mod(apba[2], msg.chat_id_)  or is_creatorbasicid(apba[2], msg.chat_id_) then
...
if ck_mod(ass[2], msg.chat_id_) or is_creatorbasicid(ass[2], msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️┇ لا تستطيع مسح رسائل (مدراء، ادمنية،مميزين)البوت   ', 1, 'md')
return false 
else
...
-----------------------------------------banall--------------------------------------------------
if text:match("^حظر عام$") and devbott(msg)  and msg.reply_to_message_id_ then
function gban_by_reply(extra, result, success)
local hash =  'tshake:'..bot_id..'gbanned:'
database:sadd(hash, result.sender_user_id_)
chat_kick(result.chat_id_, result.sender_user_id_)
...
if text:match("^حظر عام @(.*)$") and devbott(msg)  then
local apbll = {string.match(text, "^(حظر عام) @(.*)$")}
function gban_by_username(extra, result, success)
if result.id_ then
local hash =  'tshake:'..bot_id..'gbanned:'
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'zVVVn')..')\n🚫┇تم حظره من المجموعات البوت'
database:sadd(hash, result.id_)
else
texts = '✖┇خطاء'
end
...
if text:match("^حظر عام (%d+)$") and devbott(msg)  then
local apbll = {string.match(text, "^(حظر عام) (%d+)$")}
local hash =  'tshake:'..bot_id..'gbanned:'
database:sadd(hash, apbll[2])
tsX000(apbll[2],msg,"🚫┇تم حظره من المجموعات البوت")
end
if text:match("^الغاء العام$") and devbott(msg)  and msg.reply_to_message_id_ then
function ungban_by_reply(extra, result, success)
local hash =  'tshake:'..bot_id..'gbanned:'
tsX000("prore",msg,"🚫┇تم الغاء حظره من المجموعات البوت")
database:srem(hash, result.sender_user_id_)
...
if text:match("^الغاء العام @(.*)$") and devbott(msg)  then
local apid = {string.match(text, "^(الغاء العام) @(.*)$")}
function ungban_by_username(extra, result, success)
local hash =  'tshake:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'zVVVn')..')\n��┇تم الغاء حظره من المجموعات البوت'
database:srem(hash, result.id_)
else
texts = '✖┇خطاء'
end
...
if text:match("^الغاء العام (%d+)$") and devbott(msg)  then
local apbll = {string.match(text, "^(الغاء العام) (%d+)$")}
local hash =  'tshake:'..bot_id..'gbanned:'
database:srem(hash, apbll[2])
tsX000(apbll[2],msg,"🚫┇تم الغاء حظره من مجموعات البوت")
...
if text:match("^كتم عام$") and devbott(msg)  and msg.reply_to_message_id_ then
...
if text:match("^كتم عام @(.*)$") and devbott(msg)   then
...
if text:match("^كتم عام (%d+)$") and devbott(msg)  then
...
if text:match("^الغاء كتم العام$") and devbott(msg)  and msg.reply_to_message_id_ then
...
if text:match("^الغاء كتم العام (%d+)$") and devbott(msg)   then
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apsi[2] or 'zVVVn')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
if ck_mod(apsi[2], msg.chat_id_) or is_creatorbasicid(apsi[2], msg.chat_id_)  then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️┇ لا تستطيع كتم (مدراء، ادمنية،مميزين)البوت   ', 1, 'md')
return false 
else
...
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apki[2] or 'zVVVn_files')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
if ck_mod(apki[2], msg.chat_id_) or is_creatorbasicid(apki[2], msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️┇ لا تستطيع حظر او طرد (مدراء، ادمنية،مميزين)البوت   ', 1, 'md')
return false 
else
...
if text and text == "عدد القروب" and (is_mod(msg) or is_creatorbasic(msg)) then 
...
if  msg.content_.text_:match("^قائمه العام$") and devbott(msg)  then
local hash =   'tshake:'..bot_id..'gbanned:'
local list = database:smembers(hash)
...
if  msg.content_.text_:match("^المكتومين عام$") and devbott(msg)  then
local hash =   'tshake:'..bot_id..'gmuted:'
local list = database:smembers(hash)
...
if msg.sender_user_id_ == tonumber(sudo_add) then
t = 'المطور الاساسي'
elseif msg.sender_user_id_ == tonumber(1917795624) then
t = 'مطور السورس'
...
t = database:get("tshake:name_cre"..bot_id..msg.chat_id_) or 'منشئ  القروب '
elseif (database:get("tshake:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("tshake:all_if:"..database:get("tshake:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = database:get("tshake:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
elseif is_owner(msg) then
t = database:get("tshake:name_own"..bot_id..msg.chat_id_) or 'مدير القروب '
elseif is_mod(msg) then
t = database:get("tshake:name_adm"..bot_id..msg.chat_id_) or ' ادمن القروب '
...
elseif is_creator(msg) then
tshake_oop = database:get("tshake:name_cre"..bot_id..msg.chat_id_) or 'منشئ القروب'
...
tshake_oop = database:get("tshake:name_own"..bot_id..msg.chat_id_) or 'مدير القروب '
elseif is_mod(msg2) then
tshake_oop = database:get("tshake:name_adm"..bot_id..msg.chat_id_) or 'ادمن القروب'
...
ikeko_text = "عضو نشط"
elseif tonumber(user_msgs) < 3000 then 
ikeko_text = "اقوى تفاعل"
elseif tonumber(user_msgs) < 4000 then 
ikeko_text = "عضو متفاعل قوي"
elseif tonumber(user_msgs) < 5000 then 
ikeko_text = "جيد بتفاعل"
elseif tonumber(user_msgs) > 5000 then 
ikeko_text = "لحد يسولف غيره ."
end
keko = database:smembers('keko:all:pppp:tt:'..bot_id) or 0
if (keko or keko[1]) then 
for i=1, #keko do
...
if text:match("^مسح قائمه العام$") and devbott(msg)   then
text = '☑┇تم مسح قائمه العام'
database:del('tshake:'..bot_id..'gbanned:')
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
if text:match("^مسح المكتومين عام") and devbott(msg)  then
...
if (text and (text == "تعطيل الرفع") and (is_creator(msg) or is_creatorbasic(msg))) then
database:set("Tshake:lock:promote"..bot_id..msg.chat_id_,"tshake")
send(msg.chat_id_, msg.id_, 1, '☑️ ● تم تعطيل الرفع ✓', 1, 'md')
end
if (text and (text == "تفعيل الرفع")  and (is_creator(msg) or is_creatorbasic(msg))) then
database:del("Tshake:lock:promote"..bot_id..msg.chat_id_)
send(msg.chat_id_, msg.id_, 1, '☑️ ● تم تفعيل الرفع ✓', 1, 'md')
end
...
if text and text == "منشن للكل" and (is_owner(msg) or is_creatorbasic(msg)) then
...
if (text and text == 'حذف اسم البوت') and devbott(msg)   then
redis:del('tshake:'..bot_id..'name_bot')
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️┇ تم حذف اسم البوت', 1, 'html')
end
if (text and text == 'وضع اسم للبوت' or text == 'تغير اسم البوت' ) then
if tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
...
if (text and text == 'تغير امر المطور بالكليشه') and devbott(msg)  then
...
--------------------------------
if (text and text == (redis:get('tshake:'..bot_id..'name_bot') or 'بوت'))then
name_bot = (redis:get('tshake:'..bot_id..'name_bot') or 'بوت')
local namebot = {
"احلى من يناديني "..name_bot.. " هلا لبيه ي #name ",
"استغفرالله "..name_bot,
"الله يصبرني ",
"رينق رينق قول شتبي . ",
"وش في ؟",
...
'م د ى',
'مشغوله',
'هلا ياحياتي ياعمري قول .',
'تبي قناه اجر؟ ادخل هنا : @A_J_R9 .',
" لبيه ي عيني ؟ "..name_bot,
}
name = math.random(#namebot)
send(msg.chat_id_, msg.id_, 1, namebot[name] , 1, 'md') 
return false end
if (text and text == 'بوت')then
name_bot = (redis:get('tshake:'..bot_id..'name_bot') or 'مدى')
send(msg.chat_id_, msg.id_, 1, "اسمي القميل مدى . "..name_bot, 1, 'html') 
end
--------------------------------------
...
for k,v in pairs(sudo_users) do
if text:match("^تغير امر المطور$") and devbott(msg)   then
...
if text:match("^اضف مطور$")  and devbott(msg)   and msg.reply_to_message_id_ then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^اضف مطور @(.*)$") and devbott(msg)   then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^اضف مطور (%d+)$") and devbott(msg)   then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^حذف مطور$") and devbott(msg)  and msg.reply_to_message_id_ then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^حذف مطور @(.*)$") and devbott(msg)  then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^حذف مطور (%d+)$") and devbott(msg)   then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
sendd(msg.chat_id_, msg.id_, '📮| المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
sendd(msg.chat_id_, msg.id_, '📮| عذا لا يمكنك وضع معرف حسابات في الاشتراك ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
sendd(msg.chat_id_, msg.id_,'📮| عذا لا يمكنك وضع معرف مجوعه في الاشتراك ') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
sendd(msg.chat_id_, msg.id_,'📮| البوت ادمن في القناة \n📮| تم تفعيل الاشتراك الاجباري في \n📮| ايدي القناة ('..data.id_..')\n📮| معرف القناة ([@'..data.type_.channel_.username_..'])') 
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
sendd(msg.chat_id_, msg.id_,'📮| البوت ليس ادمن في القناة يرجى ترقيته ادمن ثم اعادة المحاوله ') 
end
return false  
end
end,nil)
...
sendd(msg.chat_id_, msg.id_,'📮| تم تغيير رسالة الاشتراك بنجاح ')
end

if text and text:match("^تغير الاشتراك$") and devbott(msg)   then
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
sendd(msg.chat_id_, msg.id_, '📮| حسنآ ارسل لي معرف القناة') 
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and devbott(msg)   then
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
sendd(msg.chat_id_, msg.id_, '📮| حسنآ ارسل لي النص الذي تريده') 
return false  
end
if text == "حذف رساله الاشتراك" and devbott(msg)   then
database:del(bot_id..'text:ch:user')
sendd(msg.chat_id_, msg.id_, "📮| تم مسح رساله الاشتراك ") 
return false  
end
if text == "تفعيل الاشتراك الاجباري" and devbott(msg)   then
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
sendd(msg.chat_id_, msg.id_,"📮| الاشتراك الاجباري مفعل \n📮| على القناة » ["..addchusername.."]") 
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
sendd(msg.chat_id_, msg.id_,"📮| اهلا عزيزي المطور \n📮| ارسل معرف قناتك ليتم تفعيل الاشتراك الاجباري") 
end
return false  
end
if text == "تعطيل الاشتراك الاجباري"  and devbott(msg)   then
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
sendd(msg.chat_id_, msg.id_, "📮| تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "الاشتراك الاجباري" and devbott(msg)   then
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
sendd(msg.chat_id_, msg.id_, "📮| تم تفعيل الاشتراك الاجباري \n📮| على القناة » ["..addchusername.."]") 
else
sendd(msg.chat_id_, msg.id_, "📮| لا يوجد قناة في الاشتراك الاجباري ") 
end
return false  
end
...
send(msg.chat_id_,0, 1, "⚠┇العضو : {["..data.first_name_.."](T.ME/zVVVn)}\n📛┇["..taha.."] \n" , 1, 'md') 
end
end
...
if text:match("^اضف رد عام$") and devbott(msg)   then
...
return false end
if text:match("^حذف رد للكل$") and devbott(msg)   then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد حذفها ' , 1, 'md')
...
if text:match("^مسح المطورين$") and devbott(msg)   then
...
if text:match("^مسح ردود المطور$") and devbott(msg)   then
...
if text:match("^المطورين$") and devbott(msg)   then
local list = redis:smembers('tshake:'..bot_id..'dev')
text = "👨🏿‍💻 ┇ قائمه المطورين   ،\nꔹ┉♦️┉ ┉ ┉ ┉♦️┉ꔹ \n"
for k,v in pairs(list) do
local user_info = database:hgetall('tshake:'..bot_id..'user:'..v)
...
------------------------------------
if text:match("^ردود المطور$") and devbott(msg)   then
local list = redis:smembers('tshake:'..bot_id..'kekoresudo')
...
local matches = {string.match(text, "^(تنظيف) (%d+)$")} -- ماعندك عقل مثلاً فكر وتعرف الحل يامطي
loadstring(URL.unescape("local%20function%20getParseMode(parse_mode)%0Aif%20parse_mode%20then%0Alocal%20mode%20%3D%20parse_mode%3Alower()%0Aif%20mode%20%3D%3D%20'markdown'%20or%20mode%20%3D%3D%20'md'%20then%0AP%20%3D%20%7BID%20%3D%20%22TextParseModeMarkdown%22%7D%0Aelseif%20mode%20%3D%3D%20'html'%20then%0AP%20%3D%20%7BID%20%3D%20%22TextParseModeHTML%22%7D%0Aend%20end%20return%20P%0Aend%0Afunction%20dl_cb(arg%2C%20data)%0Aend%0A--%20%20%20%20%20%20%20%20%20%C2%BB%C2%BB%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20send%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%C2%AB%C2%AB%20%20%20%20%20%20%20%20%20%20%20%20%20%20--%0Alocal%20function%20send(chat_id%2C%20reply_to_message_id%2C%20disable_notification%2C%20text%2C%20disable_web_page_preview%2C%20parse_mode)%0Aif%20text%20then%20%0A%0Alocal%20TextParseMode%20%3D%20getParseMode(parse_mode)%0Alocal%20text2%20%3D%20text%0Alocal%20text_key%20%3D%20database%3Aget('key_ts'..bot_id)%0Aif%20text_key%20then%0Aif%20parse_mode%20then%0Aif%20parse_mode%20%3D%3D%20'markdown'%20or%20parse_mode%20%3D%3D%20'md'%20then%0Aparse_mode%20%3D%20%22Markdown%22%0Aelseif%20parse_mode%20%3D%3D%20'html'%20then%0Aparse_mode%20%3D%20%22Html%22%0Aend%0Aend%0Alocal%20channel_ts%20%3D%20database%3Aget(%22channel_ts%22..bot_id)%0Alocal%20channel_user_ts%20%3D%20database%3Aget(%22channel_user_ts%22..bot_id)%0Akeyboard%20%3D%20%7B%7D%0Akeyboard.inline_keyboard%20%3D%20%7B%0A%7B%0A%7Btext%20%3D%20''..(channel_ts%20or%20%22TshAkE%20TEAM%22)..''%2C%20url%3D''..(channel_user_ts%20or%20't.me%2FzVVVn_files')..''%7D%2C%0A%7D%2C%0A%7D%0Alocal%20keko%20%3D%20%22https%3A%2F%2Fapi.telegram.org%2Fbot%22%20..token..%20'%2FsendMessage%3Fchat_id%3D'%20..%20chat_id%0Aif%20reply_to_message_id%20~%3D%200%20then%0Akeko%20%3D%20keko%20..%20'%26reply_to_message_id%3D'%20..%20reply_to_message_id%2F2097152%2F0.5%20--%20%D8%AC%D9%85%D9%8A%D8%B9%20%D8%A7%D9%84%D8%AD%D9%82%D9%88%D9%82%20%D9%85%D8%AD%D9%81%D9%88%D8%B8%D9%87%20%D9%84%D9%81%D8%B1%D9%8A%D9%82%20%D8%AA%D8%B4%D8%A7%D9%83%D9%8A%20%D9%84%D8%A7%D9%8A%D9%85%D9%83%D9%86%D9%83%20%D9%86%D8%B3%D8%AE%20%D8%A7%D9%88%20%D8%A7%D8%B3%D8%AA%D8%AE%D8%AF%D8%A7%D9%85%20%D9%87%D8%B0%D9%87%20%D8%A7%D9%84%D8%B3%D8%B7%D8%B1%20%D8%A8%D8%AF%D9%88%D9%86%20%D9%85%D9%88%D8%A7%D9%81%D9%82%D9%87%20%D8%A7%D9%84%D9%81%D8%B1%D9%8A%D9%82%0Aend%0Aif%20disable_web_page_preview%20then%0Akeko%20%3D%20keko%20..%20'%26disable_web_page_preview%3Dtrue'%0Aend%0Aif%20text%20then%0Akeko%20%3D%20keko..'%26text%3D'..URL33.escape(text2)%0Aend%0Aif%20parse_mode%20then%0Akeko%20%3D%20keko%20..%20'%26parse_mode%3D'..parse_mode%0Aend%0Akeko%20%3D%20keko..'%26reply_markup%3D'..JSON.encode(keyboard)%0Ahttps.request(keko)%0Aelse%0Atdcli_function%20(%7B%0AID%20%3D%20%22SendMessage%22%2C%0Achat_id_%20%3D%20chat_id%2C%0Areply_to_message_id_%20%3D%20reply_to_message_id%2C%0Adisable_notification_%20%3D%20disable_notification%2C%0Afrom_background_%20%3D%201%2C%0Areply_markup_%20%3D%20nil%2C%0Ainput_message_content_%20%3D%20%7B%0AID%20%3D%20%22InputMessageText%22%2C%0Atext_%20%3D%20text%2C%0Adisable_web_page_preview_%20%3D%20disable_web_page_preview%2C%0Aclear_draft_%20%3D%200%2C%0Aentities_%20%3D%20%7B%7D%2C%0Aparse_mode_%20%3D%20TextParseMode%2C%0A%7D%2C%7D%2C%20dl_cb%2C%20nil)%0Aend%0Aend%0Aend%0Alocal%20matches%20%3D%20%7Bstring.match(text%2C%20%22%5E(%D8%AA%D9%86%D8%B8%D9%8A%D9%81)%20(%25d%2B)%24%22)%7D%0Aif%20msg.chat_id_%3Amatch(%22%5E-100%22)%20then%0Aif%20tonumber(matches%5B2%5D)%20%3E%201000%20or%20tonumber(matches%5B2%5D)%20%3C%201%20then%0Apm%20%3D%20'%E2%9D%95%E2%94%87%D9%84%D8%A7%20%D8%AA%D8%B3%D8%AA%D8%B7%D9%8A%D8%B9%20%D8%AD%D8%B0%D9%81%20%D8%A7%D9%83%D8%AB%D8%B1%20%D9%85%D9%86%201000%20%D8%B1%D8%B3%D8%A7%D9%84%D9%87'%0Asend(msg.chat_id_%2C%20msg.id_%2C%201%2C%20pm%2C%201%2C%20'html')%0Aelse%0A%20%20%20%20%20id_user_keko%20%3D%20matches%5B2%5D%0Akekopp%20%3D%201048576%0A%20%20%20msg_keko_new%20%3D%20tonumber(msg.id_)%0A%09%20%20%20%20%20%20%20%20for%20i%3D1%2Ctonumber(id_user_keko)%20do%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20if%20msg_keko_new%20%3E%200%20then%20%20%0Atdcli_function%20(%7B%0AID%3D%22DeleteMessages%22%2C%0Achat_id_%3D%20msg.chat_id_%2C%0Amessage_ids_%3D%7B%5B0%5D%20%3D%20msg_keko_new%7D%0A%7D%2C%0Adl_cb%2C%20nil)%0A%20%20msg_keko_new%20%3D%20msg_keko_new-kekopp%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20end%20%0A%20%20%20%20%20%20%20%20%20%20%20%20end%20%0Apm%20%3D'%E2%98%91%E2%94%87%D8%AA%D9%85%20%7B*'..matches%5B2%5D..'*%7D%20%D9%85%D9%86%20%D8%A7%D9%84%D8%B1%D8%B3%D8%A7%D8%A6%D9%84%5Cn%F0%9F%97%91%E2%94%87%D8%AD%D8%B0%D9%81%D9%87%D8%A7%5Cn%20%5B%F0%9F%A6%81%E2%94%87%20%D9%82%D9%86%D8%A7%D8%A9%20%D8%A7%D9%84%D8%B3%D9%88%D8%B1%D8%B3%20%5D(https%3A%2F%2Ftelegram.me%2FzVVVn)'%0Asend(msg.chat_id_%2C%20msg.id_%2C%201%2C%20pm%2C%201%2C%20'md')%0Aend%0Aend"))()
end -- لا تخمط حبي لاتنحك
----------------------------------------------------------------------------------------------
...
if  (text and text == 'تفعيل وضع المدفوع') and devbott(msg)   then
...
if (text and text == 'تعطيل وضع المدفوع') and devbott(msg)   then
...
if (text and text == 'تفعيل الاذاعه') and devbott(msg)   then
...
if (text and text == 'تعطيل الاذاعه') and devbott(msg)   then
...
info = '👤┇العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'zVVVn')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
if text and text == "تعين مجموعه المطور" and devbott(msg)   then
send(msg.chat_id_, msg.id_, 1, '☑┇ تم تعين ~⪼ `'..msg.chat_id_..'`', 1, 'md')
database:set("tshake"..bot_id..":sudo:gr",msg.chat_id_)
end
if text and text == "مسح مجموعه المطور" and devbott(msg)   then
...
if (text and text == 'استعاده الاوامر') and devbott(msg)   then
...
if (text and text == 'تغير امر الاوامر') and devbott(msg)   then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if (text and text == 'تغير امر م1') and devbott(msg)   then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if (text and text == 'تغير امر م2') and devbott(msg)   then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if (text and text == 'تغير امر م3') and devbott(msg)   then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if (text and text == 'تغير امر م4') and devbott(msg)   then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
📂 ┇[𝐒𝐨𝐮𝐫𝐜𝐞 𝐌𝐚𝐝𝐚](t.me/zVVVn) .
👨‍💻 ┇[𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 : 𝐙𝐚𝐢𝐝  🎼](t.me/YDDDE) .

]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
if text:match("^رابط حذف التيلي$") or text:match("^رابط حذف$") or text:match("^رابط الحذف$") or text:match("^الرابط حذف$") or text:match("^اريد رابط الحذف$") then
local text =  [[
🗑┇رابط حذف التلي ، ⬇
...
local keyboard = {
{'الاحصائيات 📑'},
{'تنظيف المشتركين 📫','تنظيف القروبات 📄'},
{'تعطيل التفعيل التلقائي 🚸','تفعيل التفعيل التلقائي 🔱'},
{'مسح المكتومين عام 💠','مسح قائمه العام 🔖'},
{'المطورين 👮','مسح المطورين 📜'},
{'المكتومين عام 🔕','قائمه العام 🚯'},
...
if text == 'مسح المكتومين عام 💠' and devbott(msg)  then
text = '☑┇ تم مسح المكتومين عام'
database:del('tshake:'..bot_id..'gmuted:')
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
send(msg.chat_id_,0, 1, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/zVVVn)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" , 1, 'md') 
end
end
getUser(msg.sender_user_id_,get_info)
delete_msg(msg.chat_id_,{[0] = msg.id_})       
...
send(msg.chat_id_,0, 1, "[⚠┇#تحذير] \n🔖┇قام شخصآ ما في المجموعه بالتعديل على الميديا يرجى الانتباه \n📫┇الشخص الي قام بالتعديل \n ["..data.first_name_.."](T.ME/zVVVn)" , 1, 'md') 
end
end
